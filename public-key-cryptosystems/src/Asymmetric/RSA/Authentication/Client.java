    ...
    public static void main(String[] args) {
        try (Socket s = new Socket("localhost", 8080)) {
            ...
            while (true) {
                ...
                System.out.println("[INFO]\t\t> Encrypting with Client's Private Key...");
                TimeUnit.SECONDS.sleep(DELAY);
                encrypted_client_message = Algorithm.encrypt(client_message, client_private_key, n);
                ...
                System.out.println("[INFO]\t\t> Decrypting with Server's Public Key...");
                TimeUnit.SECONDS.sleep(DELAY);
                decrypted_server_message = Algorithm.decrypt(server_message, server_public_key, n);

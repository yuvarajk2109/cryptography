    ...
    public static void main(String[] args) {
        try (ServerSocket ss = new ServerSocket(8080)) {
            ...
            while (true) {
                ...
                decrypted_client_message = Algorithm.decrypt(client_message, server_private_key, n);
                ...
                TimeUnit.SECONDS.sleep(DELAY);
                encrypted_server_message = Algorithm.encrypt(server_message, client_public_key, n);

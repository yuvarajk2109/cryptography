...
//
//import static DSA_Base.Algorithms.Hash.*;
//import static DSA_Base.Algorithms.PKC.*;
//
//public class Client {
...
//                TimeUnit.SECONDS.sleep(DELAY);
//                System.out.println("[INFO]\t\t> Encrypting hash using client's private key...");
//                TimeUnit.SECONDS.sleep(DELAY);
//                encrypted_client_hash = encrypt(client_hash, client_private_key, n);
//                System.out.println("[INFO]\t\t> Encrypted hash: "+encrypted_client_hash);
//                TimeUnit.SECONDS.sleep(DELAY);
//                System.out.println("[INFO]\t\t> Combining message and encrypted hash...");
//                TimeUnit.SECONDS.sleep(DELAY);
//                final_client_message = combine(client_message, encrypted_client_hash);
...
//                encrypted_server_hash = extracted[1];
//                System.out.println("[INFO]\t\t> Message: " + server_message);
//                System.out.println("[INFO]\t\t> Encrypted hash: " + encrypted_server_hash);
//                TimeUnit.SECONDS.sleep(DELAY);
//                System.out.println("[INFO]\t\t> Decrypting hash using server's public key...");
//                TimeUnit.SECONDS.sleep(DELAY);
//                server_hash = decrypt(encrypted_server_hash, server_public_key, n);
//                System.out.println("[INFO]\t\t> Server hash: " + server_hash);
//                TimeUnit.SECONDS.sleep(DELAY);
